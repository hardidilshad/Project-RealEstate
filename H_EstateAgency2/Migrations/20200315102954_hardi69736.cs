...
{
    public partial class hardi69736 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PCityId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PCityName = table.Column<string>(nullable: true),
                    PCityNo = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PCitys", x => x.PCityId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyArea = table.Column<int>(nullable: false),
                    PropertyPrice = table.Column<double>(nullable: false),
                    PropertyYearOfBuilt = table.Column<int>(nullable: false),
                    PropertyComBuilt = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PTypeId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PTypeName = table.Column<string>(nullable: true),
                    PTypeNo = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
